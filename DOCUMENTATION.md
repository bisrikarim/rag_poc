...
*Persistent conversation history — click any conversation to reload it*
...
*Example of a query and its grounded response*
...
*Starting a new conversation with the + New chat button*
